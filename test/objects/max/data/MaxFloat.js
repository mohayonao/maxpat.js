...
import MaxFloat from "../../../../src/objects/max/data/MaxFloat";
...
describe("MaxFloat", () => {
  describe("[ float ]", () => {
    ...
    describe("basic action", () => {
      let { sender, receiverSpy } = createTestObjects(MaxFloat, opts);
  ...
  describe("[ float 7.4 ]", () => {
    ...
    describe("send action", () => {
      let { patcher, sender, receiverSpy } = createTestObjects(MaxFloat, opts);
